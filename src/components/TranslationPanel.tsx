...
import { Languages, Loader2, CheckCircle2, Lock } from 'lucide-react';
...
export const TranslationPanel: React.FC<TranslationPanelProps> = ({
  ...
  const handleTranslate = async () => {
    if (!selectedLanguage || selectedLanguage === originalLanguage || !enabled) return;
  ...
  return (
    <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
      <div className="flex items-center space-x-2 mb-4">
        <Languages className={`w-5 h-5 ${enabled ? 'text-blue-600' : 'text-gray-400'}`} />
      ...
      {!enabled ? (
        <div className="text-center py-6">
          ...
          <h4 className="font-semibold text-gray-900 mb-2">Multi-language Translation</h4>
